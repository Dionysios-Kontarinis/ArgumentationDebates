...
/**
 * This class is used in order to test, in many different configurations, the composition of (the initial) target sets of the GB.
 * It also tests the ordering of the target sets (from the smallest to the biggest).
 * @author dennis
 *
 */
public class Test_TargetSets_A {
